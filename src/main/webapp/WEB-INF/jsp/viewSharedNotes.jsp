...
<head>
    ...
    <title>Notes compartides amb jo</title>
</head>
<body>
<header>
...
<main class="container">
    ...
    <c:choose>
        <c:when test="${not empty shared}">
            <p>Aquí veurás les notes compartides amb tu</p>
        </c:when>

        <c:otherwise>
            <p>Ningú ha compartit cap nota amb tú</p>
        </c:otherwise>
            ...
            <c:forEach var="c" items="${shared}">
                <div class="card mt-3 mb-3" style="width: 25rem;">
                    <div class="card-body">
                        ...
                        <a href="/deleteSharedNoteNotOwner?noteId=${c.getNoteId()}" class="btn btn-danger">Eliminar nota</a>
                    </div>
                </div>
            </c:forEach>
        </div>
